...
#[allow(dead_code)]
pub const RUSTC: &str = r"/usr/local/rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"/usr/local/rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rustdoc";
...
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.78.0 (9b00956e5 2024-04-29)";
...
#[allow(dead_code)]
pub const RUSTDOC_VERSION: &str = r"rustdoc 1.78.0 (9b00956e5 2024-04-29)";
